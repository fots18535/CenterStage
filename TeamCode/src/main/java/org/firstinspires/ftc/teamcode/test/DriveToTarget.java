...
//                double leftX = -gamepad1.left_stick_x * slowSpeed; STRAFE
//                double leftY = gamepad1.left_stick_y * slowSpeed;
//                double rightX = gamepad1.right_stick_x * slowSpeed; TURN
//                double rightY = gamepad1.right_stick_y * slowSpeed; DRIVE

                // drive using manual POV Joystick mode.  Slow things down to make the robot more controlable.
                drive  = gamepad1.right_stick_y  / 2.0;  // Reduce drive rate to 50%.
